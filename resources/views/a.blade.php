                ...
                <table class="w-full min-w-max">
                    ...
                    <tbody class="divide-y divide-lav2 bg-white">
                        ...
                        <tr class="hover:bg-lav1/30 transition-all duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-mono text-gray-900 bg-gray-100 px-2 py-1 rounded">SWP-002</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 max-w-xs overflow-hidden">
                                    Advanced smartwatch with heart rate monitoring, GPS tracking, waterproof design, and
